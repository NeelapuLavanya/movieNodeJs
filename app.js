...
const covertMovieNameToPascalCase = (dbObject) => {
  return {
...
app.get("/movies/", async (request, response) => {
  ...
  response.send(
    moviesArray.map((moviename) => covertMovieNameToPascalCase(moviename))
  );
});
...
app.get("/directors/:directorId/movies/", async (request, response) => {
 ...
 director.director_id = ${directorId};`;
  ...
  response.send(
    movies.map((moviesnames) => convertMovieNamePascalCase(moviesnames))
  );
});
